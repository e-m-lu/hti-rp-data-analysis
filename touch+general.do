...
pwcorr avoidmean  avoidmean2 comf_mean1sq comf_mean0sq force1 force0 movement1  movement0, sig

alpha avoidshakinghandsofstrangers-annoyingwhenfriendsfamilyhug, item
alpha avoidtouchinghandsoffriends-annoyingwhenfriendsfamilyhug, item

polychoric avoidshakinghandsofstrangers-annoyingwhenfriendsfamilyhug //6 items
//polychoric avoidtouchinghandsoffriends-annoyingwhenfriendsfamilyhug //5 items
...
//Then, use the touch aversion mean to describe the data (mean of means, DV-correlation and maybe how many have a mean higher than 3). 
